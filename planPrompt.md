...
- All screens must match assets in the `design/` directory. Each screen resides in a subfolder (e.g., `design/login/`) and contains:
    - `screen.html` (reference HTML code)
    - `screen.png` (design image)
